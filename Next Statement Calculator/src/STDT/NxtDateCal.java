...
public static void main(String[] args) 
	{
	   ...
	   System.out.println("Enter the account creation date (DD)");           				// Input date
		...
		NxtDateCal calUsage = new NxtDateCal();
        calUsage.performCalendarArithmetic(AccountCreationDate,AccountCreationMonth,AccountCreationYear);
	}
