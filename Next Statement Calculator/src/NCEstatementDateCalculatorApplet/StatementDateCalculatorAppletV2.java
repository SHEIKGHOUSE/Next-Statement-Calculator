...
public class StatementDateCalculatorAppletV2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StatementDateCalculatorAppletV2 window = new StatementDateCalculatorAppletV2();
	 ...
	 */
	public StatementDateCalculatorAppletV2() {
		initialize();
	}
	...
	private void initialize() {
		...
		/*****************************************************************************************************************************/		      
				      //to check if account creation is on 29 or 30 or 31st of the month 
				      if(Date==29||Date==30||Date==31)
				      {
				    	  //if Date falls on 29th of the month
				    	  if(Date==29)
				    	  {
				    		  if (Month==4||Month==6 || Month==9 || Month==11)					// if it falls on 30 days of the month
				    		  {
				    			  cal.add(Calendar.MONTH, 0);		//moving to  next month as its NXT falls on 29th of month
				    			  cal.add(Calendar.DAY_OF_MONTH, 3); //moving to first of next month as its NXT falls on 29th of month
				        ...
				        }	//end for 30 days in a month for creation date falls on 29 30 31st
				    		  else if(Month!=2 ||Month!=1)										//if date is 29 and falls on 31 days of the month follow normal logic
					    	  {
				    			  cal.add(Calendar.MONTH, 0);		//moving to  next month as its NXT falls on 29th of month
				    			  cal.add(Calendar.DAY_OF_MONTH, 2); //moving to first of next month as its NXT falls on 29th of month
					    		  for (int i=StatementNumber;i==StatementNumber;i++)
						          {
						        	  int x=StatementNumber-1;
							        	  int j=0;
				    	  ...
				    	  if(Date==30)
				    	  {
				    		  if (Month==4||Month==6 || Month==9 || Month==11)					// if it falls on 30 days of the month
				    		  {
				    			  cal.add(Calendar.MONTH, 0);		//moving to  next month as its NXT falls on 30th of month
				    			  cal.add(Calendar.DAY_OF_MONTH, 2); //moving to first of next month as its NXT falls on 30th of month
						    	  for (int i=StatementNumber;i==StatementNumber;i++)
						          {
						        	  int x=StatementNumber-1;
							        	  int j=0;
				        ...
				        }	//end for 30 days in a month for creation date falls on29 30 31st
				    		  
				    		  else if(Month!=2 ||Month!=1)										//if date is 29 and falls on 31 days of the month follow normal logic
					    	  {
				    			  cal.add(Calendar.MONTH, 0);		//moving to  next month as its NXT falls on 29th of month
				    			  cal.add(Calendar.DAY_OF_MONTH, 1); //moving to first of next month as its NXT falls on 29th of month
					    		  for (int i=StatementNumber;i==StatementNumber;i++)
						          {
						        	  int x=StatementNumber-1;
							        	  int j=0;
				    	  ...
				    	  if(Date==31)
				    	  {
				    		  if (Month==4||Month==6 || Month==9 || Month==11)					// if it falls on 30 days of the month
				    		  {
				    			  cal.add(Calendar.MONTH, 0);		//moving to  next month as its NXT falls on 31st of month
				    			  cal.add(Calendar.DAY_OF_MONTH, 1); //moving to first of next month as its NXT falls on 31st of month
						    	  for (int i=StatementNumber;i==StatementNumber;i++)
						          {
						        	  int x=StatementNumber-1;
							        	  int j=0;
			    		  ...
			    		  for (int i=StatementNumber;i==StatementNumber;i++)
				          {
						     ...
						     //     SimpleDateFormat LPDD = new SimpleDateFormat("d MMM yyyy");
							  //    String LWIPDDDate = LPDD.format(cal.getTime());
							   ...
							   //   System.out.println(StatementNumber+"  State LWI NXT PDD = "+  LWIStatementdate);
							    //  System.out.println(StatementNumber+"  LWI NXT PDD = "+  LWIPDDDate);
							      textField_2.setText(StatementNumber+"   PDD = "+LWIStatementdate);
							      textField_3.setText(StatementNumber+"   Statement = "+LWIPDDDate);	//
...
/***************************************************************************************************************************************************************************/
		...
		lblNewLabel_5.setBounds(178, 412, 358, 14);
