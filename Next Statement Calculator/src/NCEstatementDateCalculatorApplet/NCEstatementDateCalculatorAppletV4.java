...
public class NCEstatementDateCalculatorAppletV4 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StatementDateCalculatorAppletVersoin3 window = new StatementDateCalculatorAppletVersoin3();
	 ...
	 */
	public NCEstatementDateCalculatorAppletV4() {
		initialize();
	}
	...
	private void initialize() {
		...
		frmNceStatementForecast.setBounds(100, 100, 554, 510);
		...
		comboBox_3.setBounds(384, 202, 45, 20);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		btnNewButton.setBounds(214, 238, 89, 23);
		...
		textField.setBounds(193, 308, 165, 23);
		...
		textField_1.setBounds(193, 355, 165, 23);
		...
		textField_2.setBounds(193, 402, 165, 23);
		...
		lblPleaseSelectThe.setBounds(84, 204, 290, 14);
		...
		lblNewLabel_5.setBounds(84, 447, 358, 14);
		frmNceStatementForecast.getContentPane().add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("Please select the brand type of the credit account");
		lblNewLabel_6.setBounds(81, 152, 348, 14);
		frmNceStatementForecast.getContentPane().add(lblNewLabel_6);
		
		JComboBox comboBox_4 = new JComboBox();
		comboBox_4.setForeground(Color.BLACK);
		comboBox_4.setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(199, 21, 133), new Color(255, 255, 0), new Color(0, 0, 205), new Color(255, 0, 0)));
		comboBox_4.setBounds(343, 149, 45, 20);
